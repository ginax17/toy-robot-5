...
def is_position_blocked(x,y):
    """The function returns true if the position (x,y) falls inside an obstacles_list"""
...
def is_path_blocked(x1,y1, x2, y2):
    """This function returns true if there is an obstacles_list in the line between the coordinates (x1, y1) and (x2, y2)."""
    # if x1==x2 or y1==y2:
    #     return True
    # else:
    #     return False
